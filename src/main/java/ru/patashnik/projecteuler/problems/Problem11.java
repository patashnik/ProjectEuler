    ...
    public String solve() {
        ...
        for (int i = 0; i < 20; i++) {
            for (int j = 0; j < 20; j++) {
                ...
                if (j >= 0 && j <= 16) {
                    int rProduct = 1;
                    for (int k = j, right = j + 4; k < right; k++) {
                        if (grid[i][k] == 0) {
                            break;
                        }
                        rProduct *= grid[i][k];
                ...
                if (i >= 0 && i <= 16 && j >= 0 && j <= 16) {
                    int rdProduct = 1;
                    for (int k = j, l = i, rd = j + 4; k < rd; k++, l++) {
                        if (grid[l][k] == 0) {
                            break;
                        }
                        rdProduct *= grid[l][k];
                    }
                    if (rdProduct > product) {
                        product = rdProduct;
                    }
                }
                ...
                if (i >= 0 && i <= 16 && j >= 3) {
                    int ldProduct = 1;
                    for (int k = j, l = i, ld = j - 4; k > ld; k--, l++) {
                        if (grid[l][k] == 0) {
                            break;
                        }
                        ldProduct *= grid[l][k];
                    }
                    if (ldProduct > product) {
                        product = ldProduct;
                    }
                }
            }
