...
public class Problem8 implements Problem {
    ...
    public String solve() {
        ...
        for (int start = 0, end = sequence.length() - count; start <= end; start++) {
            String substr = sequence.substring(start, start + count);
            char[] digits = substr.toCharArray();
            long digitProduct = 1;
            for (char digit : digits) {
                digitProduct *= Integer.parseInt(Character.toString(digit));
            }
